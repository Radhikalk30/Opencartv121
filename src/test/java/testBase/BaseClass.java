...
public class BaseClass {
	...
	//BaseClass contains TestCases which are required repeatedly to achive Reusability
...
public Properties p;
	...
	public void setup(String os , String br) throws IOException
	{
		...
		if(p.getProperty("execution_env").equalsIgnoreCase("remote"))
		{
			...
			break;
			case "default": System.out.println("No matching browser");
			return;
	...
	public void tearDown()
	{
	  ...
	  generatedNumber=RandomStringUtils.randomNumeric(10); return generatedNumber;
	  }
